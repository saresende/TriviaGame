...
$('.answer').on ("click", function answers(objButton) {
	...
	if (place < 10) {	
		...
		//$('#right').html("You nailed it!!!!! Got em' good!");
		//$('#wrong').html("Nice try but....do better.");
		//$('#noanswer').html("You forgot to answer silly head!");
		//$('#continue').html(continueGame);
		showQuestions = setTimeout(questionDisplay, 1000);
